        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
              <h3 class="mt-4 mb-3 text-dark">Tambah Data Siswa</h3>
            </div>
          </form>
          <!-- Topbar Navbar -->
                  ...
                  <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                      <div class="form-group">
                        ...
                        <input type="text" maxlength="125" class="form-control" id="validationCustom02" name="nama" placeholder="Masukkan Nama Officer" required>
                      ...
                      <div class="form-group mt-3">
                        ...
                        <input type="email" maxlength="125" class="form-control" id="validationCustom02" name="email" placeholder="Masukkan Email" required>
                        <div class="valid-feedback">
                          Looks good!
                        </div>
                        <div class="invalid-feedback">
                      ...
                      <div class="form-group mt-3">
                        ...
                        <input type="password" maxlength="125" class="form-control" id="validationCustom02" name="password" placeholder="Masukkan Nama Password" required>
                        <div class="valid-feedback">
                          Looks good!
                        </div>
                        <div class="invalid-feedback">
